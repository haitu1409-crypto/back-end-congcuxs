 ...
 */
const getSpecialSetNumbers = (setId) => {
 ...
 */
const getCombinedSpecialSetNumbers = (setIds) => {
 ...
 * @returns {Array} Mảng objects chứa {id, numbers, count}
 */
const getAllSpecialSets = () => {
    return Array.from(SPECIAL_SETS.entries()).map(([id, numbers]) => ({
        id,
        numbers,
 ...
 */
const findSetsContainingNumber = (number) => {
